...
import { LoaderOrbit } from "@/components/ui/sp-loaders";
      ...
      <div className="bg-surface rounded-xl border border-border w-full max-w-md shadow-lg flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-8 flex flex-col items-center text-center space-y-6">
          <div className="flex items-center justify-center gap-4">
            ...
            <div
              className={`w-16 h-16 rounded-2xl bg-surface-elevated border border-border shadow-sm flex items-center justify-center ${platform.color}`}
            >
          ...
          {step === "init" && (
            <div className="space-y-4">
              <p className="text-sm text-text-secondary">
                You are about to securely connect your {platform.name} account
                to SocialPulse. We only request the permissions necessary to
                publish posts and read analytics.
              </p>
              <button
          ...
          {step === "connecting" && (
            ...
            >
              <LoaderOrbit size={120} label="Waiting for authorization" />
              <p
              ...
              >
                Complete the flow in the popup window.
              </p>
            </div>
          )}
          ...
          {step === "success" && (
            <div className="space-y-4 flex flex-col items-center">
              ...
              <p className="text-sm text-text-secondary">
                Your {platform.name} account is now ready to use.
              </p>
            </div>
          )}
        </div>
